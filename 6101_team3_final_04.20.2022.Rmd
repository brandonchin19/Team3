...
#Accuracy for our model is 72.9%  Recall Rate is 73.9 
...
cfm<-confusionMatrix(data=pc, reference = e)



x<-data.frame("target"=c(0,1,0,1),"prediction"=c(0,0,1,1),"n"=c(780, 288, 306, 817))

#"title"=c("780, 306, 288, 817")
...
cfm
ggplot(x, aes(x = target, y = reorder(prediction, desc(prediction))  , fill = n)) +
  geom_tile(color = "black") +
  geom_text(aes(label = n), color = "Yellow", size = 4) +labs(x = "Prediction",y = "True/False")+
  coord_fixed()
