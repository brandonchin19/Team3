...
# V. Building Logistic Regression Model and Classification Trees
...
At the top (Node1), is the overall probability of loan approval. It shows the proportion of applicants that get approved for their loan. 50 percent of applicants get approved. This is expected given that our balanced dataset technique set the split to 50/50.

Node1 asks whether the interest rate is less than 4.5, If yes, 37 percent of applicants have no chance to have their loan approved; if no, 63 percent of applicants have 79 percent chance of having their loan denied. 

In Node2, asking if the interest rate is equal or greater than 4.5, If yes, 50 percent of applicant have a 100 percent chance of having their loan denied; if no, 13 percent of applicants will be denied. 
...
We have a score of 99 percent for the test set. There is a high likelihood of overfitting. 
