...
``` {r}
contable4 = table(loans$applicant_age, loans$action)
...
#Start the logistic regression modeling
```{r}
library(ISLR)
m1<-glm(actionb~derived_race+derived_sex+derived_ethnicity-1, family = binomial(link = "logit"), data=loans )
summary(m1)
```
