...
#Chi-Square Test for Loan Approval and Race
``` {r}
loadPkg("MASS")
contable1 = table(loans$derived_race, loans$action)
...
#Chi-Square Test for Loan Approval and Sex
```{r}
...
```
```{r}
contable3 = table(loans$derived_ethnicity, loans$action)
