...
cha_cols <- unlist(lapply(hmda_ca, is.character))
cha_cols <- subset(cha_cols,cha_cols=='TRUE')
cha_cols
summary(cha_cols)
logi_cols <- unlist(lapply(hmda_ca, is.logical))
logi_cols <- subset(cha_cols,logi_cols=='TRUE')
logi_cols
summary(logi_cols)
```
...
barplot(hmda_ca_final_1, beside = TRUE,
        col = c("derived_sex", "applicant_age", "derived_ethnicity",
                "action_taken"),
        legend.text = rownames(hmda_ca_final_1), ylim = c(0, 100))
